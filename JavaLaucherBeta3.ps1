$Set_JavaLacucher = {
   ...
   Function WriteOutputDebug([System.Boolean]$showMsg,[System.String]$textMsg){
    ...
    function Set-CLASSPATH([System.String]$textMsg){
        if (IsValidString($textMsg)){
            ...
            if (($Env:CLASSPATH) -eq ($null)){
             ...
             throw "Please Contact System Administrator [ERRO] Set-CLASSPATH";
        };
    };
    Set-CLASSPATH($(Get-ChildItem Env:JAVA_HOME)[0].Value.ToString() + "\lib");
